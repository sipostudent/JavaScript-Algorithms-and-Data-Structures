...
/*
    ...
    They are a constant value, which means that once a variable is 
    ...
    (objects and arrays). In a later challenge you will see an example of a 
    lowercase variable identifier being used for an array.
