...
/*
    ...
    for name and color? It's possible to change the properties of 
    ...
    Then pass in the values as arguments to define each unique bird 
    into the Bird constructor: let cardinal = new Bird("Bruce", "red"); 
    This gives a new instance of Bird with name and color properties 
    set to Bruce and red, respectively. The numLegs property is still 
    ...
    Then create a new Dog saved in a variable terrier. Pass it two 
